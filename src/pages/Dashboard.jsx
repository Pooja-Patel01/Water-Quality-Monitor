    ...
    <div className="min-h-screen flex bg-sky-50 text-slate-800 font-sans">
      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <header className="flex justify-between items-center mb-8">
            ...
            <span className="bg-red-100 text-red-600 px-4 py-1 rounded-full text-xs font-bold border border-red-200">3 Active Alerts</span>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            ...
            { label: 'Temp', value: '18.6 °C', color: 'text-sky-700', border: 'border-sky-400' }
          ].map((stat, i) => (
